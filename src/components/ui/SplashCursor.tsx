...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function updatePointerMoveData(
      ...
      // Add movement threshold to reduce sensitivity to tiny movements
      const movementThreshold = 0.001;
      const totalMovement = Math.sqrt(pointer.deltaX * pointer.deltaX + pointer.deltaY * pointer.deltaY);
      
      pointer.moved = totalMovement > movementThreshold;
      
      // Dampen small movements further
      if (totalMovement < movementThreshold * 3) {
        pointer.deltaX *= 0.3;
        pointer.deltaY *= 0.3;
      }
